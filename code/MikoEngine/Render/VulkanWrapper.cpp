...
namespace vkWrapper
{
	...
	void Instance::Init()
	{
		...
		appInfo.pEngineName = "Micro Engine";
	...
	DebugMessenger::DebugMessenger(std::shared_ptr<Instance> vkinstance)
		: VkInstanceObject<DebugMessenger>(vkinstance)
	{
	}
	...
	void DebugMessenger::Init()
	{
		...
		if (CreateDebugUtilsMessengerEXT(m_parent.lock()->Get(), &createInfo, nullptr, &m_messenger) != VK_SUCCESS) 
		{
	...
	{
		DestroyDebugUtilsMessengerEXT(m_parent.lock()->Get(), m_messenger, nullptr);
	}
	...
	Surface::Surface(std::shared_ptr<Instance> vkinstance, GLFWwindow* window)
		: VkInstanceObject<Surface>(vkinstance)
		, m_window(window)
	{
	}
	...
	void Surface::Init()
	{
		if (glfwCreateWindowSurface(m_parent.lock()->Get(), m_window, nullptr, &m_surface) != VK_SUCCESS)
		{
	...
	void Surface::Close()
	{
		vkDestroySurfaceKHR(m_parent.lock()->Get(), m_surface, nullptr);
	}
