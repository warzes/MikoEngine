...
{
	SE_ALIGNED(16) glm::mat4 view_proj;
};
...
public:
	...
	inline void set_distance_fade(const bool& fade)
	{
		m_distance_fade = fade;
	}
	inline bool distance_fade()
	{
		return m_distance_fade;
	}

	inline void set_fade_start(const float& fade)
	{
		m_fade_start = fade;
	}
	inline bool fade_start()
	{
		return m_fade_start;
	}

	inline void set_fade_end(const float& fade)
	{
		m_fade_end = fade;
	}
	inline bool fade_end()
	{
		return m_fade_end;
	}
