...
#include "Renderer/Resource/MaterialBlueprint/Cache/GraphicsPipelineStateCacheManager.h"
#include "Renderer/Resource/MaterialBlueprint/Cache/ComputePipelineStateCacheManager.h"
	...
	*/
	...
	public:
		...
		*/
		...
		{
			UNKNOWN = 0,	// Unknown buffer usage, supports the following "Renderer::MaterialProperty::Usage": "UNKNOWN_REFERENCE", "GLOBAL_REFERENCE" as well as properties with simple values
	...
	public:
		...
		*    RHI command buffer to fill
		*/
		void fillComputeCommandBuffer(Rhi::CommandBuffer& commandBuffer);
