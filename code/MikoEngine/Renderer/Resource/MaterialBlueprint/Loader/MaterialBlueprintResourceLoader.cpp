...
#include "Renderer/Resource/MaterialBlueprint/Loader/MaterialBlueprintFileFormat.h"
...
namespace Renderer
{
	...
	bool MaterialBlueprintResourceLoader::isFullyLoaded()
	{
		...
		if (IResource::LoadingState::LOADED != mRenderer.getVertexAttributesResourceManager().getResourceByResourceId(mMaterialBlueprintResource->mVertexAttributesResourceId).getLoadingState())
		{
			// Not fully loaded
			return false;
		}
